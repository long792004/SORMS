...
export function HomePage() {
  ...
  return (
    <section className="space-y-10">
      <div className="relative overflow-hidden border-b border-slate-200 bg-white dark:border-white/10 dark:bg-slate-950">
        <img
        ...
        <div className="page-shell absolute inset-0 flex flex-col justify-center gap-5">
          <motion.h1 initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl text-h1 font-heading text-white">
            Smart premium booking experience for modern residents
          </motion.h1>
          <p className="max-w-xl text-slate-100">Book rooms, manage invoices, and track services in one premium platform.</p>
          <SearchBar
            location={location}
            checkIn={checkIn}
            checkOut={checkOut}
          ...
          />
          <Button className="w-fit" onClick={() => navigate("/rooms")}>Explore Rooms</Button>
        </div>
      </div>
